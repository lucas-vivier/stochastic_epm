...
def get_renewable_data(power_type, locations, start_date, end_date, api_token=API_TOKEN, dataset="merra2", capacity=1, system_loss=0.1, height=100, tracking=0, tilt=35, azim=180,
                       turbine='Vestas+V80+2000', local_time='true'):
    """
...
if __name__ == '__main__':
    ...
    # Example usage:
    name_data = "maharashtra"
    locations = [(18.9068, 75.6742)]   # List of (latitude, longitude) tuples
    ...
    for year in range(1987, 2023):
        ...
        data = get_renewable_data(power_type, locations, start_date, end_date)
